// Create a NEW demo article with AI-generated content and modern structure
...
const imageUrls = {
    featured: 'https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1200&q=80', // Green tech/Sustainability
    content1: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80', // Data/Chart
    content2: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=80', // Business/Finance
    content3: 'https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?auto=format&fit=crop&w=1200&q=80', // Nature/Environment
    content4: 'https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?auto=format&fit=crop&w=1200&q=80', // Technology/Innovation
};
...
// Generate article with new structure
async function createNewDemoArticle() {
    try {
        const topic = "Künstliche Intelligenz und Nachhaltigkeit: Wie KI unsere Umwelt retten kann";
        const categoryName = "Technologie";
        
        console.log('\n🚀 Creating NEW Demo Article with AI-Generated Content...');
        ...
        const demoArticle = {
            title: topic,
            slug: "ki-nachhaltigkeit-umwelt-retten-2025",
            excerpt: "Entdecken Sie, wie Künstliche Intelligenz dabei hilft, die größten Umweltprobleme unserer Zeit zu lösen – von der Reduzierung von CO2-Emissionen bis hin zu nachhaltiger Landwirtschaft.",
            ...
            status: 'published',
            view_count: 0,
            meta_title: 'KI und Nachhaltigkeit: Wie Künstliche Intelligenz unsere Umwelt retten kann',
            meta_description: 'Erfahren Sie, wie Künstliche Intelligenz dabei hilft, Umweltprobleme zu lösen, CO2-Emissionen zu reduzieren und nachhaltige Lösungen zu schaffen.',
            meta_keywords: ['KI', 'Nachhaltigkeit', 'Umwelt', 'Künstliche Intelligenz', 'Klimaschutz', 'Green Tech'],
        ...
        console.log(`🔗 URL: http://localhost:3000/article.html?slug=${demoArticle.slug}`);
        console.log('\n' + '='.repeat(60));
        console.log('📋 NEW Article Structure Features:');
        console.log('- AI-generated fresh content');
        console.log('- Modern HTML structure');
        console.log('- DIFFERENT images for each placement');
        console.log('- Varied layouts (images left/right/full-width)');
        console.log('- Interactive elements (info boxes, quotes)');
        console.log('- Engaging storytelling style');
        console.log('- Multiple visual elements');
        console.log('- Call to action at the end');
        console.log('='.repeat(60));
...
module.exports = { createNewDemoArticle, generateArticleContent };
